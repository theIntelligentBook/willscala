    ...
    site.toc = site.Toc(
      ...
      "3. Funcitons as values" -> site.Toc(
        ...
        "Solving Einstein's Puzzle" -> site.add("einsteinProblem",
          ...
          Alternative("Watch the video", Video(() => PlayableVideo(Echo360Video("76d0ede4-aa24-4dc6-9862-fc4d09a970b0")))),
      ...
      "4. Types" -> site.Toc(
        ...
        "Type Systems" -> site.add("typeSystems",
          ...
          Alternative("Watch the video", Video(() => PlayableVideo(Echo360Video("759c957c-7dc3-4d8c-894a-40175ffe0210")))),
        ),
        "Type Relationships" -> site.add("typeRelationships",
          Alternative("Slide deck", Deck(() => types.typeRelationships)),
          Alternative("Video part 1", Video(() => PlayableVideo(Echo360Video("8aa85973-9e65-456d-939f-24c33f678090")))),
          Alternative("Video part 2", Video(() => PlayableVideo(Echo360Video("36c5c1a3-5476-4486-b0d4-50f856e22b3a")))),
        ),
      ),
